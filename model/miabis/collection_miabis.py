from miabis_model import Collection, Gender

from model.interface.collection_interface import CollectionInterface


class CollectionMiabis(Collection, CollectionInterface):
    def __init__(self, identifier: str, name: str, managing_biobank_id: str,
        ...
        super().__init__(identifier=identifier, name=name, managing_biobank_id=managing_biobank_id,
                         ...
                         country=country, genders=[Gender.UNKNOWN], material_types=material_types, number_of_subjects=0,
                         alias=alias, url=url, description=description, dataset_type=dataset_type,
